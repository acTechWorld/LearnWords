...
import kotlinx.android.synthetic.main.activity_oral_traduction_menu.*
import kotlin.random.Random

class OralTraductionMenu : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_oral_traduction_menu)
        var gson = Gson()
